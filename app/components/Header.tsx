...
const Hub71Logo = () => (
  <svg width="120" height="32" viewBox="0 0 120 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <text x="0" y="24" fontFamily="Arial Black, Arial" fontWeight="900" fontSize="24" fill="#000000">HUB71</text>
  </svg>
);
...
const SearchIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M16 16L20 20" stroke="#1A2B4A" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
const AccessibilityIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 8V14M12 14L8 22M12 14L16 22" stroke="#1A2B4A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
const MenuIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 6H20M4 12H20M4 18H20" stroke="#1A2B4A" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
